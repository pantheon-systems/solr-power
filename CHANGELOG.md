...
* Added SOLRPOWER_DISABLE_AUTOCOMMIT to disable autocommitting of posts [[#559](https://github.com/pantheon-systems/solr-power/pull/559)]
* Moved CHANGELOG to it's own file.
* Added `$post->score` value to parsed search results.
